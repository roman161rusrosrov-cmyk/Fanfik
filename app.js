(() => {
  ...
  const SCENE_CAPTIONS = [
    ...
    ["Сообщение перед занятием", "Пауза без давления"],
    ...
    ["Ви у соседнего стола", "Лёгкая поддержка с опасной ценой"],
    ["Двенадцать сообщений Ви", "Один честный знак Роме"],
    ["Чужая исповедь в школьном канале", "Разговор без требования пароля"],
    ["Граница для Ви", "Маленькие правды вместо проверки"],
    ["Старый двор Армавира", "Решение о Бердянске"],
    ["Возвращение к старому окну", "Семейная дорога"],
    ["Двойные дворники УАЗа", "Сообщение перед ремонтом"],
    ...
    ["Вишня у бабушкиной калитки", "Сообщение перед заливом"],
    ["Два берега в одном чате", "Пауза без наказания"],
    ["Плёночная камера на подоконнике", "Список дел на холодильнике"],
